...
export async function deleteHomeItemViaApi(input: { apartmentId: number; itemId: number }) {
  await apiRequest<void>(`/apartments/${input.apartmentId}/home-items/${input.itemId}`, {
    method: 'DELETE',
  })
}
